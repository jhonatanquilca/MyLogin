...
/**
 * Created by Administrador on 24/10/2015.
 */
public class RequestHandler {
    ...
    public JSONObject objectRequest(int method, String url) {


//        final JSONObject response[] = new JSONObject[1];

        JsonObjectRequest request = new JsonObjectRequest(method, url, (String) null,
                new Response.Listener<JSONObject>() {
